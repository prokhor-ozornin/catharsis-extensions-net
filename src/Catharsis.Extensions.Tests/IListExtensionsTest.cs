...
/// </summary>
/// <seealso cref="IListExtensions"/>
public sealed class IListExtensionsTest : Test
{
  /// <summary>
  ...
  public void Randomize_Method()
  {
    using (new AssertionScope())
    {
      ...
      var enumerable = new object[] { 1, string.Empty, "2", Guid.NewGuid(), null, 10.5 };
      collection = [.. enumerable];
      collection.Randomize().Should().BeOfType<IList<object>>().And.BeSameAs(collection).And.Contain(enumerable);
    }
