...
public static class XmlWriterExtensions
{
  ...
  extension(XmlWriter writer)
  {
    ...
    public XmlWriter WriteBytes(IEnumerable<byte> bytes, Encoding encoding = null)
    {
    ...
    public async Task<XmlWriter> WriteBytesAsync(IEnumerable<byte> bytes, Encoding encoding = null)
    {
      if (writer is null) throw new ArgumentNullException(nameof(writer));
      if (bytes is null) throw new ArgumentNullException(nameof(bytes));
    ...
    public async Task<XmlWriter> WriteTextAsync(string text)
    {
      if (writer is null) throw new ArgumentNullException(nameof(writer));
      if (text is null) throw new ArgumentNullException(nameof(text));
    ...
    public XmlDictionaryWriter ToXmlDictionaryWriter() => writer is not null ? XmlDictionaryWriter.CreateDictionaryWriter(writer) : throw new ArgumentNullException(nameof(writer));
  }
}