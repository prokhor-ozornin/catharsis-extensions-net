...
public static class RandomExtensions
{
  ...
  /// <returns></returns>
  public static sbyte Sbyte(this Random random, sbyte? min = null, sbyte? max = null) => random is not null ? (sbyte) random.Next(min ?? sbyte.MinValue, max ?? sbyte.MaxValue) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static IEnumerable<sbyte> SbyteSequence(this Random random, int count, sbyte? min = null, sbyte? max = null) => random is not null ? count.Objects(() => random.Sbyte(min, max)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static byte Byte(this Random random, byte? min = null, byte? max = null) => random is not null ? (byte) random.Next(min ?? byte.MinValue, max ?? byte.MaxValue) : throw new ArgumentNullException(nameof(random));
  ...
  public static IEnumerable<byte> ByteSequence(this Random random, int count, byte? min = null, byte? max = null) => random is not null ? count.Objects(() => random.Byte(min, max)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static short Short(this Random random, short? min = null, short? max = null) => random is not null ? (short) random.Next(min ?? short.MinValue, max ?? short.MaxValue) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static IEnumerable<short> ShortSequence(this Random random, int count, short? min = null, short? max = null) => random is not null ? count.Objects(() => random.Short(min, max)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static ushort Ushort(this Random random, ushort? min = null, ushort? max = null) => random is not null ? (ushort) random.Next(min ?? ushort.MinValue, max ?? ushort.MaxValue) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static IEnumerable<ushort> UshortSequence(this Random random, int count, ushort? min = null, ushort? max = null) => random is not null ? count.Objects(() => random.Ushort(min, max)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static int Int(this Random random, int? min = null, int? max = null) => random?.Next(min ?? int.MinValue, max ?? int.MaxValue) ?? throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static IEnumerable<int> IntSequence(this Random random, int count, int? min = null, int? max = null) => random is not null ? count.Objects(() => random.Int(min, max)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static uint Uint(this Random random, uint? min = null, uint? max = null) => random is not null ? (uint) random.Long(min, max) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static IEnumerable<uint> UintSequence(this Random random, int count, uint? min = null, uint? max = null) => random is not null ? count.Objects(() => random.Uint(min, max)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static long Long(this Random random, long? min = null, long? max = null) => random?.NextInt64(min ?? long.MinValue, max ?? long.MaxValue) ?? throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static IEnumerable<long> LongSequence(this Random random, int count, long? min = null, long? max = null) => random is not null ? count.Objects(() => random.Long(min, max)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="count"></param>
  /// <returns></returns>
  public static IEnumerable<float> FloatSequence(this Random random, int count) => random is not null ? count.Objects(random.Float) : throw new ArgumentNullException(nameof(random));
#endif
  ...
  /// <param name="count"></param>
  /// <returns></returns>
  public static IEnumerable<double> DoubleSequence(this Random random, int count) => random is not null ? count.Objects(random.Double) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static char Char(this Random random, char? min = null, char? max = null) => random is not null ? (char) random.Next(min ?? char.MinValue, max ?? char.MaxValue) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static IEnumerable<char> CharSequence(this Random random, int count, char? min = null, char? max = null) => random is not null ? count.Objects(() => random.Char(min, max)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static string String(this Random random, int count, char? min = null, char? max = null) => random is not null ? count > 0 ? random.CharSequence(count, min, max).AsArray().ToText() : string.Empty : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static IEnumerable<string> StringSequence(this Random random, int size, int count, char? min = null, char? max = null) => random is not null ? count.Objects(() => random.String(size, min, max)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="count"></param>
  /// <returns></returns>
  public static IEnumerable<string> DigitsSequence(this Random random, int size, int count) => random is not null ? count.Objects(() => random.Digits(size)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="count"></param>
  /// <returns></returns>
  public static IEnumerable<string> LettersSequence(this Random random, int size, int count) => random is not null ? count.Objects(() => random.Letters(size)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="count"></param>
  /// <returns></returns>
  public static IEnumerable<string> AlphaDigitsSequence(this Random random, int size, int count) => random is not null ? count.Objects(() => random.AlphaDigits(size)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static IEnumerable<SecureString> SecureStringSequence(this Random random, int size, int count, char? min = null, char? max = null) => random is not null ? count.Objects(() => random.SecureString(size, min, max)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static DateTime DateTime(this Random random, DateTime? min = null, DateTime? max = null) => random is not null ? new DateTime(random.Long((min ?? System.DateTime.MinValue).Ticks, (max ?? System.DateTime.MaxValue).Ticks), DateTimeKind.Utc) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static IEnumerable<DateTime> DateTimeSequence(this Random random, int count, DateTime? min = null, DateTime? max = null) => random is not null ? count.Objects(() => random.DateTime(min,  max)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static DateTimeOffset DateTimeOffset(this Random random, DateTimeOffset? min = null, DateTimeOffset? max = null) => random is not null ? new DateTimeOffset(random.Long((min ?? System.DateTimeOffset.MinValue).Ticks, (max ?? System.DateTimeOffset.MaxValue).Ticks), TimeSpan.Zero) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static IEnumerable<DateTimeOffset> DateTimeOffsetSequence(this Random random, int count, DateTimeOffset? min = null, DateTimeOffset? max = null) => random is not null ? count.Objects(() => random.DateTimeOffset(min, max)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static IEnumerable<DateOnly> DateOnlySequence(this Random random, int count, DateOnly? min = null, DateOnly? max = null) => random is not null ? count.Objects(() => random.DateOnly(min, max)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static TimeOnly TimeOnly(this Random random, TimeOnly? min = null, TimeOnly? max = null) => random is not null ? System.TimeOnly.FromTimeSpan(TimeSpan.FromTicks(random.Long((min ?? System.TimeOnly.MinValue).Ticks, (max ?? System.TimeOnly.MaxValue).Ticks))) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static IEnumerable<TimeOnly> TimeOnlySequence(this Random random, int count, TimeOnly? min = null, TimeOnly? max = null) => random is not null ? count.Objects(() => random.TimeOnly(min, max)) : throw new ArgumentNullException(nameof(random));
#endif
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static Range Range(this Random random, int? max = null) => random is not null ? System.Range.EndAt(Index.FromStart(random.Int(0, max))) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static IEnumerable<Range> RangeSequence(this Random random, int count, int? max = null) => random is not null ? count.Objects(() => random.Range(max)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="directory"></param>
  /// <returns></returns>
  public static FileInfo BinaryFile(this Random random, int size, byte? min = null, byte? max = null, DirectoryInfo directory = null)
  {
    if (random is null) throw new ArgumentNullException(nameof(random));
    if (size < 0) throw new ArgumentOutOfRangeException(nameof(size));
  ...
  /// <returns></returns>
  public static async Task<FileInfo> BinaryFileAsync(this Random random, int size, byte? min = null, byte? max = null, DirectoryInfo directory = null, CancellationToken cancellation = default)
  {
    if (random is null) throw new ArgumentNullException(nameof(random));
    if (size < 0) throw new ArgumentOutOfRangeException(nameof(size));
  ...
  /// <param name="directory"></param>
  /// <returns></returns>
  public static IEnumerable<FileInfo> BinaryFileSequence(this Random random, int size, int count, byte? min = null, byte? max = null, DirectoryInfo directory = null)
  {
    if (random is null) throw new ArgumentNullException(nameof(random));
    if (size < 0) throw new ArgumentOutOfRangeException(nameof(size));
    if (count < 0) throw new ArgumentOutOfRangeException(nameof(count));
    ...
    {
      yield return random.BinaryFile(size, min, max, directory);
    }
  }
  ...
  /// <param name="cancellation"></param>
  /// <returns></returns>
  public static async IAsyncEnumerable<FileInfo> BinaryFileSequenceAsync(this Random random, int size, int count, byte? min = null, byte? max = null, DirectoryInfo directory = null, [EnumeratorCancellation] CancellationToken cancellation = default)
  {
    if (random is null) throw new ArgumentNullException(nameof(random));
    if (size < 0) throw new ArgumentOutOfRangeException(nameof(size));
    if (count < 0) throw new ArgumentOutOfRangeException(nameof(count));
  ...
  /// <param name="directory"></param>
  /// <returns></returns>
  public static FileInfo TextFile(this Random random, int size, Encoding encoding = null, char? min = null, char? max = null, DirectoryInfo directory = null)
  {
    if (random is null) throw new ArgumentNullException(nameof(random));
    if (size < 0) throw new ArgumentOutOfRangeException(nameof(size));
  ...
  /// <param name="directory"></param>
  /// <returns></returns>
  public static IEnumerable<FileInfo> TextFileSequence(this Random random, int size, int count, Encoding encoding = null, char? min = null, char? max = null, DirectoryInfo directory = null)
  {
    if (random is null) throw new ArgumentNullException(nameof(random));
    if (size < 0) throw new ArgumentOutOfRangeException(nameof(size));
    if (count < 0) throw new ArgumentOutOfRangeException(nameof(count));
    ...
    for (var i = 1; i <= count; i++)
    {
      yield return random.TextFile(size, encoding, min, max, directory);
    }
  }
  ...
  /// <param name="cancellation"></param>
  /// <returns></returns>
  public static async Task<FileInfo> TextFileAsync(this Random random, int size, Encoding encoding = null, char? min = null, char? max = null, DirectoryInfo directory = null, CancellationToken cancellation = default)
  {
    if (random is null) throw new ArgumentNullException(nameof(random));
    if (size < 0) throw new ArgumentOutOfRangeException(nameof(size));
  ...
  /// <param name="cancellation"></param>
  /// <returns></returns>
  public static async IAsyncEnumerable<FileInfo> TextFileSequenceAsync(this Random random, int size, int count, Encoding encoding = null, char? min = null, char? max = null, DirectoryInfo directory = null, [EnumeratorCancellation] CancellationToken cancellation = default)
  {
    if (random is null) throw new ArgumentNullException(nameof(random));
    if (size < 0) throw new ArgumentOutOfRangeException(nameof(size));
    if (count < 0) throw new ArgumentOutOfRangeException(nameof(count));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static IPAddress IpAddress(this Random random, uint? min = null, uint? max = null) => random is not null ? new IPAddress(random.Uint(min, max)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static IEnumerable<IPAddress> IpAddressSequence(this Random random, int count, uint? min = null, uint? max = null) => random is not null ? count.Objects(() => random.IpAddress(min, max)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static PhysicalAddress PhysicalAddress(this Random random, int size, byte? min = null, byte? max = null)
  {
    if (random is null) throw new ArgumentNullException(nameof(random));
    if (size < 0) throw new ArgumentOutOfRangeException(nameof(size));

    return new PhysicalAddress(random.ByteSequence(size, min, max).AsArray());
  }
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static IEnumerable<PhysicalAddress> PhysicalAddressSequence(this Random random, int count, int size, byte? min = null, byte? max = null)
  {
    if (random is null) throw new ArgumentNullException(nameof(random));
    if (count < 0) throw new ArgumentOutOfRangeException(nameof(count));
    if (size < 0) throw new ArgumentOutOfRangeException(nameof(size));

    return count.Objects(() => random.PhysicalAddress(size, min, max));
  }
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static MemoryStream MemoryStream(this Random random, int count, byte? min = null, byte? max = null)
  {
    if (random is null) throw new ArgumentNullException(nameof(random));
    if (count < 0) throw new ArgumentOutOfRangeException(nameof(count));
    ...
    if (count > 0)
    {
      stream.WriteBytes(random.ByteSequence(count, min, max)).MoveToStart();
    }
  ...
  /// <param name="cancellation"></param>
  /// <returns></returns>
  public static async Task<MemoryStream> MemoryStreamAsync(this Random random, int count, byte? min = null, byte? max = null, CancellationToken cancellation = default)
  {
    if (random is null) throw new ArgumentNullException(nameof(random));
    if (count < 0) throw new ArgumentOutOfRangeException(nameof(count));
    ...
    if (count > 0)
    {
      (await stream.WriteBytesAsync(random.ByteSequence(count, min, max), cancellation).ConfigureAwait(false)).MoveToStart();
    }
  ...
  /// <param name="max"></param>
  /// <returns></returns>
  public static Stream Stream(this Random random, byte? min = null, byte? max = null) => random is not null ? new RandomStream(min, max) : throw new ArgumentNullException(nameof(random));
