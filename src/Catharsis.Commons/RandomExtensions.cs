...
public static class RandomExtensions
{
  ...
  public static sbyte Sbyte(this Random random, sbyte? from = null, sbyte? to = null)
  {
    ...
    var minValue = from ?? sbyte.MinValue;
    var maxValue = to ?? sbyte.MaxValue;

    return (sbyte) random.Next(Min(minValue, maxValue), Max(minValue, maxValue));
  }
  ...
  /// <param name="to"></param>
  /// <returns></returns>
  public static IEnumerable<sbyte> SbyteSequence(this Random random, int count, sbyte? from = null, sbyte? to = null) => random is not null ? count.Objects(() => random.Sbyte(from, to)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="to"></param>
  /// <returns></returns>
  public static byte Byte(this Random random, byte? from = null, byte? to = null) => random is not null ? (byte) random.Next(from ?? byte.MinValue, to ?? byte.MaxValue) : throw new ArgumentNullException(nameof(random));
  ...
  public static IEnumerable<byte> ByteSequence(this Random random, int count, byte? from = null, byte? to = null) => random is not null ? count.Objects(() => random.Byte(from, to)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="to"></param>
  /// <returns></returns>
  public static short Short(this Random random, short? from = null, short? to = null) => random is not null ? (short) random.Next(from ?? short.MinValue, to ?? short.MaxValue) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="to"></param>
  /// <returns></returns>
  public static IEnumerable<short> ShortSequence(this Random random, int count, short? from = null, short? to = null) => random is not null ? count.Objects(() => random.Short(from, to)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="to"></param>
  /// <returns></returns>
  public static ushort Ushort(this Random random, ushort? from = null, ushort? to = null) => random is not null ? (ushort) random.Next(from ?? ushort.MinValue, to ?? ushort.MaxValue) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="to"></param>
  /// <returns></returns>
  public static IEnumerable<ushort> UshortSequence(this Random random, int count, ushort? from = null, ushort? to = null) => random is not null ? count.Objects(() => random.Ushort(from, to)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="to"></param>
  /// <returns></returns>
  public static int Int(this Random random, int? from = null, int? to = null) => random?.Next(from ?? int.MinValue, to ?? int.MaxValue) ?? throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="to"></param>
  /// <returns></returns>
  public static IEnumerable<int> IntSequence(this Random random, int count, int? from = null, int? to = null) => random is not null ? count.Objects(() => random.Int(from, to)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="to"></param>
  /// <returns></returns>
  public static uint Uint(this Random random, uint? from = null, uint? to = null) => random is not null ? (uint) random.Long(from, to) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="to"></param>
  /// <returns></returns>
  public static IEnumerable<uint> UintSequence(this Random random, int count, uint? from = null, uint? to = null) => random is not null ? count.Objects(() => random.Uint(from, to)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="to"></param>
  /// <returns></returns>
  public static long Long(this Random random, long? from = null, long? to = null) => random?.NextInt64(from ?? long.MinValue, to ?? long.MaxValue) ?? throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="to"></param>
  /// <returns></returns>
  public static IEnumerable<long> LongSequence(this Random random, int count, long? from = null, long? to = null) => random is not null ? count.Objects(() => random.Long(from, to)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="to"></param>
  /// <returns></returns>
  public static IEnumerable<char> CharSequence(this Random random, int count, char? from = null, char? to = null) => random is not null ? count.Objects(() => random.Char(from, to)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="to"></param>
  /// <returns></returns>
  public static IEnumerable<string> StringSequence(this Random random, int size, int count, char? from = null, char? to = null) => random is not null ? count.Objects(() => random.String(size, from, to)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="to"></param>
  /// <returns></returns>
  public static IEnumerable<SecureString> SecureStringSequence(this Random random, int size, int count, char? from = null, char? to = null) => random is not null ? count.Objects(() => random.SecureString(size, from, to)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="to"></param>
  /// <returns></returns>
  public static IEnumerable<DateTime> DateTimeSequence(this Random random, int count, DateTime? from = null, DateTime? to = null) => random is not null ? count.Objects(() => random.DateTime(from,  to)) : throw new ArgumentNullException(nameof(random));
  ...
  /// <param name="to"></param>
  /// <returns></returns>
  public static IEnumerable<PhysicalAddress> PhysicalAddressSequence(this Random random, int count, int size, byte? from = null, byte? to = null)
  {
    if (random is null) throw new ArgumentNullException(nameof(random));
    if (count < 0) throw new ArgumentOutOfRangeException(nameof(count));
    if (size < 0) throw new ArgumentOutOfRangeException(nameof(size));
