...
public static class ReflectionExtensions
{
  ...
  public static EventInfo AnyEvent(this Type type, string name) => type.GetEvent(name, BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static);
  ...
  public static FieldInfo AnyField(this Type type, string name) => type.GetField(name, BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static);
  ...
  public static PropertyInfo AnyProperty(this Type type, string name) => type.GetProperty(name, BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static);
  ...
  public static MethodInfo AnyMethod(this Type type, string name) => type.GetMethod(name, BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.Static);
  ...
  public static ConstructorInfo DefaultConstructor(this Type type) => type.GetConstructor(Array.Empty<Type>());
  ...
  /// <returns></returns>
  public static object Instance(this Type type, IEnumerable<object> arguments) => Activator.CreateInstance(type, BindingFlags.Public | BindingFlags.NonPublic | BindingFlags.Instance, null, arguments?.AsArray(), null);
  ...
  public static IEnumerable<object> Attributes(this MemberInfo member, Type type) => member.GetCustomAttributes(type, true);
  ...
  public static Type ToType(this MemberInfo member) => member.MemberType switch
  {
  ...
  /// <returns>A delegate of the specified type to represent the specified static method.</returns>
  public static Delegate ToDelegate(this MethodInfo method, Type type) => Delegate.CreateDelegate(type, method);
  ...
  public static Delegate And(this Delegate left, Delegate right) => Delegate.Combine(left, right);
  ...
  public static Delegate Not(this Delegate left, Delegate right) => Delegate.Remove(left, right);
  ...
  public static Stream Resource(this Assembly assembly, string name) => assembly.GetManifestResourceStream(name);
}