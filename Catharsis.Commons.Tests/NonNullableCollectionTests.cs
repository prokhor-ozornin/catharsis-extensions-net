...
{
  /// <summary>
  ///   <para>Tests set for class <see cref="NonNullableCollection{T}"/>.</para>
  /// </summary>
  public sealed class NonNullableCollectionTests
  {
    /// <summary>
    ...
    ///   <list type="bullet">
    ///     <item><description><see cref="NonNullableCollection{T}.CopyTo(Array, int)"/></description></item>
