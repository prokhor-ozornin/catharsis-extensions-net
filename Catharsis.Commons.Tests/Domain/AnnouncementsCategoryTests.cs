...
namespace Catharsis.Commons.Domain
{
  ...
  public sealed class AnnouncementsCategoryTests : CategoryUnitTests<AnnouncementsCategory>
  {
    ...
    public void Xml_Method()
    {
      ...
      Assert.True(new AnnouncementsCategory("id", "language", "name").Xml().ToString() == xml.ToString());
      ...
      Assert.True(new AnnouncementsCategory("id", "language", "name", new AnnouncementsCategory("parent.id", "parent.language", "parent.name"), "description").Xml().ToString() == xml.ToString());
      Assert.True(AnnouncementsCategory.Xml(category.Xml()).Equals(category));
    }
  }
}