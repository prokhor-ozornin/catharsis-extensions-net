...
{
  /// <summary>
  ///   <para>Tests set for class <see cref="UniqueDictionary{TKey,TValue}"/>.</para>
  /// </summary>
  public sealed class UniqueDictionaryTests
  {
    /// <summary>
    ...
    ///   <list type="bullet">
    ///     <item><description><see cref="UniqueDictionary{TKey,TValue}.Add(TKey, TValue)"/></description></item>
    ...
    ///   <para>Performs testing of following methods :</para>
    ///   <list type="bullet">
    ///     <item><description><see cref="UniqueDictionary{TKey,TValue}.Remove(TKey)"/></description></item>
