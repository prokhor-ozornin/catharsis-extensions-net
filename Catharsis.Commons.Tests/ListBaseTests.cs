...
{
  /// <summary>
  ///   <para>Tests set for class <see cref="ListBase{T}"/>.</para>
  /// </summary>
  public sealed class ListBaseTests
  {
    /// <summary>
    ...
    ///   <list type="bullet">
    ///     <item><description><see cref="ListBase{T}.Add(object)"/></description></item>
    ...
    ///   <para>Performs testing of following methods :</para>
    ///   <list type="bullet">
    ///     <item><description><see cref="ListBase{T}.Contains(object)"/></description></item>
    ...
    ///   <para>Performs testing of following methods :</para>
    ///   <list type="bullet">
    ///     <item><description><see cref="ListBase{T}.CopyTo(Array, int)"/></description></item>
    ...
    ///   <para>Performs testing of following methods :</para>
    ///   <list type="bullet">
    ///     <item><description><see cref="ListBase{T}.IndexOf(object)"/></description></item>
    ...
    ///   <para>Performs testing of following methods :</para>
    ///   <list type="bullet">
    ///     <item><description><see cref="ListBase{T}.Insert(int, object)"/></description></item>
    ...
    ///   <para>Performs testing of following methods :</para>
    ///   <list type="bullet">
    ///     <item><description><see cref="ListBase{T}.Remove(object)"/></description></item>
