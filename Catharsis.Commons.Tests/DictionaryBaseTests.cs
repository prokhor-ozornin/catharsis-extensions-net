...
{
  /// <summary>
  ///   <para>Tests set for class <see cref="DictionaryBase{TKey,TValue}"/>.</para>
  /// </summary>
  public sealed class DictionaryBaseTests
  {
    ...
    ///   <list type="bullet">
    ///     <item><description><see cref="DictionaryBase{TKey, TValue}.Add(object, object)"/></description></item>
    ///     <item><description><see cref="DictionaryBase{TKey, TValue}.Add(TKey, TValue)"/></description></item>
    ...
    ///   <para>Performs testing of following methods :</para>
    ///   <list type="bullet">
    ///     <item><description><see cref="DictionaryBase{TKey, TValue}.Contains(object)"/></description></item>
    ...
    ///   <para>Performs testing of following methods :</para>
    ///   <list type="bullet">
    ///     <item><description><see cref="DictionaryBase{TKey, TValue}.CopyTo(Array, int)"/></description></item>
    ...
    ///   <para>Performs testing of following methods :</para>
    ///   <list type="bullet">
    ///     <item><description><see cref="DictionaryBase{TKey, TValue}.Remove(object)"/></description></item>
    ///     <item><description><see cref="DictionaryBase{TKey, TValue}.Remove(TKey)"/></description></item>
    ...
    /// <summary>
    ///   <para>Performs testing of following class indexers :</para>
    ///   <list type="bullet">
    ///     <item><description><see cref="DictionaryBase{TKey, TValue}.this[object]"/></description></item>
