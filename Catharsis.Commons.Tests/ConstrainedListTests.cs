...
{
  /// <summary>
  ///   <para>Tests set for class <see cref="ConstrainedList{T}"/>.</para>
  /// </summary>
  public sealed class ConstrainedListTests
  {
    /// <summary>
    ...
    ///   <list type="bullet">
    ///     <item><description><see cref="ConstrainedList{T}.IndexOf(object)"/></description></item>
    ...
    ///   <para>Performs testing of following methods :</para>
    ///   <list type="bullet">
    ///     <item><description><see cref="ConstrainedList{T}.Insert(int, object)"/></description></item>
