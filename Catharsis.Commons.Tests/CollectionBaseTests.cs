...
{
  /// <summary>
  ///   <para>Tests set for class <see cref="CollectionBase{T}"/>.</para>
  /// </summary>
  public sealed class CollectionBaseTests
  {
    /// <summary>
    ...
    ///   <list type="bullet">
    ///     <item><description><see cref="CollectionBase{T}.CopyTo(Array, int)"/></description></item>
