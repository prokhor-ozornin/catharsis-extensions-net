...
namespace Catharsis.Commons.Extensions
{
  ...
  public sealed class TextReaderExtensionsTests
  {
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="TextReaderExtensions.XmlDocument(TextReader, bool)"/> method.</para>
    /// </summary>
    [Fact]
    public void XmlDocument_Method()
    {
      Assert.Throws<ArgumentNullException>(() => TextReaderExtensions.XmlDocument(null));
      Assert.Throws<XmlException>(() => TextReaderExtensions.XmlDocument(TextReader.Null));
