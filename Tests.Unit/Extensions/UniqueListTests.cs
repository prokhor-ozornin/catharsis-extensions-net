...
{
  /// <summary>
  ///   <para>Tests set for class <see cref="UniqueList{T}"/>.</para>
  /// </summary>
  public sealed class UniqueListTests
  {
    ...
    ///   <list type="bullet">
    ///     <item><description><see cref="UniqueList{T}.IndexOf(object)"/></description></item>
    ...
    ///   <para>Performs testing of following methods :</para>
    ///   <list type="bullet">
    ///     <item><description><see cref="UniqueList{T}.Insert(int, object)"/></description></item>
