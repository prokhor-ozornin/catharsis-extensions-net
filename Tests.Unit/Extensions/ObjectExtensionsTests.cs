...
namespace Catharsis.Commons.Extensions
{
  ...
  public sealed class ObjectExtensionsTests
  {
    ...
    ///   <list type="bullet">
    ///     <item><description><see cref="ObjectExtensions.Binary(object)"/></description></item>
    ///     <item><description><see cref="ObjectExtensions.Binary(object, Stream, bool)"/></description></item>
    ///   </list>
    /// </summary>
    [Fact]
    public void Binary_Methods()
    {
      Assert.Throws<ArgumentNullException>(() => ObjectExtensions.Binary(null));
      Assert.Throws<ArgumentNullException>(() => ObjectExtensions.Binary(null, Stream.Null));
      Assert.Throws<ArgumentNullException>(() => ObjectExtensions.Binary(new object(), null));
    ...
    ///   <para>Performs testing of following methods :</para>
    ///   <list type="bullet">
    ///     <item><description><see cref="ObjectExtensions.Xml{T}(T, IEnumerable{Type})"/></description></item>
    ///     <item><description><see cref="ObjectExtensions.Xml{T}(T, Type[])"/></description></item>
    ///     <item><description><see cref="ObjectExtensions.Xml{T}(T, Stream, IEnumerable{Type})"/></description></item>
    ///     <item><description><see cref="ObjectExtensions.Xml{T}(T, Stream, Type[])"/></description></item>
    ///     <item><description><see cref="ObjectExtensions.Xml{T}(T, TextWriter, IEnumerable{Type})"/></description></item>
    ///     <item><description><see cref="ObjectExtensions.Xml{T}(T, TextWriter, Type[])"/></description></item>
    ///     <item><description><see cref="ObjectExtensions.Xml{T}(T, XmlWriter, IEnumerable{Type})"/></description></item>
    ...
    public void Xml_Methods()
    {
      ...
      Assert.Throws<ArgumentNullException>(() => ObjectExtensions.Xml(new object(), (Stream)null));
      Assert.Throws<ArgumentNullException>(() => ObjectExtensions.Xml<object>(null, TextWriter.Null));
      Assert.Throws<ArgumentNullException>(() => ObjectExtensions.Xml(new object(), (TextWriter)null));
      Assert.Throws<ArgumentNullException>(() => ObjectExtensions.Xml<object>(null, XmlWriter.Create(Stream.Null)));
      Assert.Throws<ArgumentNullException>(() => ObjectExtensions.Xml(new object(), (XmlWriter)null));
