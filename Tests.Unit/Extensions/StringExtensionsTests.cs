...
namespace Catharsis.Commons.Extensions
{
  ...
  public sealed class StringExtensionsTests
  {
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="StringExtensions.DecodeHTML(string)"/> method.</para>
    /// </summary>
    [Fact]
    public void DecodeHTML_Method()
    {
      Assert.Throws<ArgumentNullException>(() => StringExtensions.DecodeHTML(null));
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="StringExtensions.EncodeHTML(string)"/> method.</para>
    /// </summary>
    [Fact]
    public void EncodeHTML_Method()
    {
      Assert.Throws<ArgumentNullException>(() => StringExtensions.EncodeHTML(null));
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="StringExtensions.Secure(string)"/> method.</para>
    /// </summary>
    [Fact]
    public void Secure_Method()
    {
      Assert.Throws<ArgumentNullException>(() => StringExtensions.Secure(null));
