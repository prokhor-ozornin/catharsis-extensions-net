...
namespace Catharsis.Commons.Extensions
{
  ...
  public sealed class StreamExtensionsTests
  {
    ...
    public void Buffered_Method()
    {
      ...
      Assert.Throws<ArgumentOutOfRangeException>(() => StreamExtensions.Buffered(Stream.Null, -1));
      Assert.Throws<ArgumentOutOfRangeException>(() => StreamExtensions.Buffered(Stream.Null, 0));
    ...
    ///   <list type="bullet">
    ///     <item><description><see cref="StreamExtensions.Deflate(Stream, CompressionMode)"/></description></item>
    ///     <item><description><see cref="StreamExtensions.Deflate{STREAM}(STREAM, byte[])"/></description></item>
    ///     <item><description><see cref="StreamExtensions.Deflate(Stream)"/></description></item>
    ///   </list>
    /// </summary>
    [Fact]
    public void Deflate_Methods()
    {
      ...
      Assert.Throws<ArgumentNullException>(() => StreamExtensions.Deflate(Stream.Null, null));
    ...
    ///   <para>Performs testing of following methods :</para>
    ///   <list type="bullet">
    ///     <item><description><see cref="StreamExtensions.GZip(Stream, CompressionMode)"/></description></item>
    ///     <item><description><see cref="StreamExtensions.GZip{STREAM}(STREAM, byte[])"/></description></item>
    ///     <item><description><see cref="StreamExtensions.GZip(Stream)"/></description></item>
    ///   </list>
    /// </summary>
    [Fact]
    public void GZip_Method()
    {
      ...
      Assert.Throws<ArgumentNullException>(() => StreamExtensions.GZip(Stream.Null, null));
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="StreamExtensions.XmlDocument(Stream, bool)"/> method.</para>
    /// </summary>
    [Fact]
    public void XmlDocument_Method()
    {
      Assert.Throws<ArgumentNullException>(() => StreamExtensions.XmlDocument(null));
      Assert.Throws<XmlException>(() => StreamExtensions.XmlDocument(Stream.Null));
