...
namespace Catharsis.Commons.Domain
{
  ...
  public sealed class DreamTests : EntityUnitTests<Dream>
  {
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="Dream.Equals(object)"/> and <see cref="Dream.GetHashCode()"/> methods.</para>
    /// </summary>
    [Fact]
    ...
    public void Xml_Methods()
    {
      ...
      Assert.True(dream.Image.File.Hash == Guid.Empty.ToByteArray().EncodeSHA512().EncodeHex());
