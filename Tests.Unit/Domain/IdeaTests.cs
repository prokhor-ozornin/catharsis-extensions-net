...
namespace Catharsis.Commons.Domain
{
  ...
  public sealed class IdeaTests : EntityUnitTests<Idea>
  {
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="Idea.Equals(object)"/> and <see cref="Idea.GetHashCode()"/> methods.</para>
    /// </summary>
    [Fact]
    ...
    public void Xml_Methods()
    {
      ...
      Assert.True(idea.Image.File.Hash == Guid.Empty.ToByteArray().EncodeSHA512().EncodeHex());
