...
namespace Catharsis.Commons.Domain
{
  ...
  public sealed class PlaycastTests : EntityUnitTests<Playcast>
  {
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="Playcast.Equals(object)"/> and <see cref="Playcast.GetHashCode()"/> methods.</para>
    /// </summary>
    [Fact]
    ...
    public void Xml_Methods()
    {
      ...
      Assert.True(playcast.Audio.File.Hash == Guid.Empty.ToByteArray().EncodeSHA512().EncodeHex());
      ...
      Assert.True(playcast.Image.File.Hash == Guid.Empty.ToByteArray().EncodeSHA512().EncodeHex());
