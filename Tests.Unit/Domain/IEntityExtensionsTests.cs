...
namespace Catharsis.Commons.Domain
{
  ...
  public sealed class IEntityExtensionsTests
  {
    ...
    public void WithId_Method()
    {
      ...
      Assert.Throws<ArgumentNullException>(() => IEntityExtensions.WithId(Enumerable.Empty<IEntity>(), null));
      Assert.Throws<ArgumentException>(() => IEntityExtensions.WithId(Enumerable.Empty<IEntity>(), string.Empty));
