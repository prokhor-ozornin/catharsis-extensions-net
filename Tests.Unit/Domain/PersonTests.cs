...
namespace Catharsis.Commons.Domain
{
  ...
  public sealed class PersonTests : EntityUnitTests<Person>
  {
    ...
    /// <summary>
    ///   <para>Performs testing of <see cref="Person.Equals(object)"/> and <see cref="Person.GetHashCode()"/> methods.</para>
    /// </summary>
    [Fact]
    ...
    public void Xml_Methods()
    {
      ...
      Assert.True(person.Image.File.Hash == Guid.Empty.ToByteArray().EncodeSHA512().EncodeHex());
