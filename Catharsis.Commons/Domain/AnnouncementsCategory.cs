...
namespace Catharsis.Commons.Domain
{
  ...
  public class AnnouncementsCategory : Category, IEquatable<AnnouncementsCategory>
  {
    ...
    public static AnnouncementsCategory Xml(XElement xml)
    {
      ...
      return new AnnouncementsCategory((string)xml.Element("Id"), (string)xml.Element("Language"), (string)xml.Element("Name"), xml.Element("Parent") != null ? Xml(xml.Element("Parent")) : null, (string)xml.Element("Description"));
    }
    ...
    /// <returns></returns>
    public bool Equals(AnnouncementsCategory other)
    {
